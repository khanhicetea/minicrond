...
var contractRoutes = []contractRoute{
	...
	{"GET", "/api/v1/runs", "List runs"}, {"GET", "/api/v1/runs/{id}", "Run detail"}, {"POST", "/api/v1/runs/{id}/stop", "Stop run"}, {"GET", "/api/v1/runs/{id}/log", "Windowed tagged logs"}, {"GET", "/api/v1/runs/{id}/log/raw", "Raw log download"}, {"GET", "/api/v1/runs/{id}/log/stream", "Resumable SSE logs"},
